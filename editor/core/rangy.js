define("Cedtory/editor/core/rangy",function(require,exports,module){
...
rangy.createModule("WrappedRange", function(api, module) {
    ...
    if (api.features.implementsDomRange) {
        ...
        (function() {
            ...
            if (util.isHostMethod(range, "getClientRects")) {
                rangeProto.getClientRects = function() {
                    var nr = this.nativeRange;
                    if (nr.getClientRects) {
                        return nr.getClientRects();
                    } else {
            ...
            if (util.isHostMethod(range, "getBoundingClientRect")) {
                rangeProto.getBoundingClientRect = function() {
                    var nr = this.nativeRange;
                    if (nr.getBoundingClientRect) {
                        return nr.getBoundingClientRect();
                    } else {
